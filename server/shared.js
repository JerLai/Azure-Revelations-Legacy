...
/**
 * Taken from https://github.com/Jerenaux/ensemble/blob/master/game/js/shared/shared.js
 * Created by Jerome on 03-05-17.
 */
let onServer = (typeof window === 'undefined');
...
shared.sanitizeCoordinates = function(x,y){ // ensure that a pair of coordinates is not out of bounds ; coordinates in px
    return {
        x: shared.clamp(x,0,shared.config.worldWidth/shared.config.cellWidth - 1),
        y: shared.clamp(y,0,shared.config.worldHeight/shared.config.cellHeight - 1)
    };
};
